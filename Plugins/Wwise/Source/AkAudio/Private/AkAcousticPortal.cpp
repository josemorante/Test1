...
AkRoomID UAkPortalComponent::GetFrontRoom() const { return FrontRoom.IsValid() ? FrontRoom->GetRoomID() : AkRoomID(); }
AkRoomID UAkPortalComponent::GetBackRoom() const { return BackRoom.IsValid() ? BackRoom->GetRoomID() : AkRoomID(); }
